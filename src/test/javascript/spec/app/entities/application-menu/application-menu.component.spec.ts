...
import { ApplicationMenuComponent } from 'app/entities/application-menu/application-menu.component';
...
describe('Component Tests', () => {
  describe('ApplicationMenu Management Component', () => {
    let comp: ApplicationMenuComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApplicationMenuComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.applicationMenus && comp.applicationMenus[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
