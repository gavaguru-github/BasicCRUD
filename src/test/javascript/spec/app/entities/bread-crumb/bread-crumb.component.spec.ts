...
import { BreadCrumbComponent } from 'app/entities/bread-crumb/bread-crumb.component';
...
describe('Component Tests', () => {
  describe('BreadCrumb Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.breadCrumbs && comp.breadCrumbs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
