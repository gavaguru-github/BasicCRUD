...
describe('Service Tests', () => {
  describe('BreadCrumb Service', () => {
    ...
    let elemDefault: IBreadCrumb;
    let expectedResult: IBreadCrumb | IBreadCrumb[] | boolean | null;
    beforeEach(() => {
      ...
      elemDefault = new BreadCrumb(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of BreadCrumb', () => {
        const returnedFromService = Object.assign(
          {
            path: 'BBBBBB',
            name: 'BBBBBB'
